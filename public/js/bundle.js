      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Nicely done, you have logged in');
            setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Sorry man! not correct info!');
        case 10:
        case "end":
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"logout.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alert.showAlert)(_context.t0);
        case 11:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"setting.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.settingUpdate = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var settingUpdate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var endpoint, newUserInfo;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          endpoint = type === 'data' ? 'updateme' : 'updatepassword';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'patch',
        ...
        case 4:
          ...
          if (newUserInfo.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " Information updated"));
          }
          _context.next = 11;
          break;
        case 8:
  ...
  return function settingUpdate(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MWYaoF5JdTnKbJt9oIQkkWPed02TGezfUAQFsdumsAFFKOO3vUH6PTd6W1yJNrfWP4MN547Hx0xuz1pQz3bfZ5L00WtGpDMX7');
          _context.prev = 1;
          _context.next = 4;
...
if (updateData) {
  updateData.addEventListener('submit', function (e) {
    ...
    (0, _setting.settingUpdate)(form, 'data');
  });
}
if (updatePassword) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _setting.settingUpdate)({
